...
# LICENSE.txt file under the same directory of that file
...
from segment_anything_hq.modeling.common import LayerNorm2d, MLPBlock
...
class ImageEncoderViT(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        interm_embeddings = torch.cat(interm_embeddings, dim=0).unsqueeze(1)
